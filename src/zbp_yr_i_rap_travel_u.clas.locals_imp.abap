...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD update.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx = CORRESPONDING zyrsrap_travel_x( <entity> MAPPING FROM ENTITY ).
...
CLASS lsc_ZYR_I_RAP_TRAVEL_U DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZYR_I_RAP_TRAVEL_U IMPLEMENTATION.
